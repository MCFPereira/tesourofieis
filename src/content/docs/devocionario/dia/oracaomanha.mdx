...
<div class="side-by-side not-content">
  <span>
    ...
    regnas in sǽcula sæculórum. Amen. Ó Senhor Deus, Rei do céu e da terra,
    dignai-Vos dirigir e santificar, mandar e governar os nossos corações e os
    nossos corpos, os nossos pensamentos, as nossas palavras e as nossas acções,
    segundo a vossa lei e no cumprimento dos vossos Mandamentos, afim de que
    aqui e eternamente com vosso auxílio mereçamos alcançar a salvação e a
    liberdade, Ó Salvador do mundo, que viveis e reinais por todos os séculos
    dos séculos. Amen.
  </span>
</div>
